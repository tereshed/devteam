...
SANDBOX_BUILDABLE_STEMS := base claude hermes antigravity
...
sandbox-build-antigravity: sandbox-build-base

sandbox-build: sandbox-build-base sandbox-build-claude sandbox-build-hermes sandbox-build-antigravity
