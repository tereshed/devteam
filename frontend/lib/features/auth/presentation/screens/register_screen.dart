...
///
/// Использует AuthController для управления состоянием регистрации.
        ...
        if (mounted) {
          ...
          if (e is AuthException) {
            if (e is InvalidCredentialsException) {
              ...
              message = e.message ?? l10n.errorNetwork;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: l10n.confirmPasswordPlaceholder,
                      ...
                      validator: (value) {
                        if (value == null || value.isEmpty) {
                          return l10n.confirmPasswordPlaceholder;
                        }
